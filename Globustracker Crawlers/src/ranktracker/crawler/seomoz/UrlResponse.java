...
/**
 * A Pojo to capture the json response from URL Metrics
 *
 * @author Sushant Gupta <sushant@globussoft.com>
 */
public class UrlResponse {

    static Logger l = Logger.getLogger(UrlResponse.class.getName());
    /**
     * The title of the page if available. For example: "Request-Response
     * Format"
     */
    private String ut;
    /**
     * The url of the page. For example:
     * "apiwiki.seomoz.org/Request-Response+Format"
     */
    private String uu;
    /**
    ...
    private String ftrr;
    /**
     * The mozTrust of the root domain of the url. Requesting this metric will
     * provide both the pretty 10-point score (ptrp) and the raw score (ptrr).
     */
    private String ptrp;
    /**
     * The mozTrust of the root domain of the url. Requesting this metric will
    ...
    private String ptrr;
    /**
     * he portion of the url's mozRank coming from external links. Requesting
    ...
    private String pjr;
    /**
     * If the url canaonicalizes to a different form, that canonical form will
    ...
    private String fuid;
    /**
     * Total links (including internal and nofollow links) to the root domain of
     * the url in question.
     */
    private String puid;
    /**
     * The number of root domains with at least one link to the subdomain of the
     * url in question.
     */
    private String fipl;
    /**
