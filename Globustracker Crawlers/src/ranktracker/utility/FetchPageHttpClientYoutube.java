...
public class FetchPageHttpClientYoutube extends Thread  {
    ...
    public FetchPageHttpClientYoutube() {
        try {
    ...
    public String fetchPageSourceString_Get(String urlToFetch, String region) throws IOException {
        region = "www." + region;
        String page = "";
        boolean b = true;
        int i = 0;
            ...
            while (b) {
                try {
                    if (isblocked) {
                        page = null;
                        Thread.sleep(240000);
                        String temppage = getSource(urlToFetch, region);
