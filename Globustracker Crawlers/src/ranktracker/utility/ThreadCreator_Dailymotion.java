...
import ranktracker.crawler.dailymotion.WebRankDailyMotion;
 ...
 * @author user
 */
public class ThreadCreator_Dailymotion extends Thread {

    static Logger l = Logger.getLogger(ThreadCreator_Dailymotion.class.getName());
    /**
    ...
    public ThreadCreator_Dailymotion(ApplicationContext appContext) {
     ...
     *
     */
    public ThreadCreator_Dailymotion(Set<String> setDomains, List<Serpkeywords> lstKeywords, ApplicationContext appContext) {
    ...
    public void run() {
        ...
        for (int iCountz = 0; iCountz <= 9; iCountz++) {
            ...
            try {
                googleThread[iCountz] = new Thread(new WebRankDailyMotion(iCountz, lstKeywords, appContext, startTrackId, endtrackId));
