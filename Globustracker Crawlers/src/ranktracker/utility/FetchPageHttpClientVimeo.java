...
public class FetchPageHttpClientVimeo extends Thread {
    ...
    public static FetchPageHttpClientVimeo getInstance() {
        if (fetchPageInstance == null) {
            fetchPageInstance = new FetchPageHttpClientVimeo();
        }
    ...
    public String fetchPageSourceString_Get(String urlToFetch, String referer) throws IOException {
        ...
        try {
            ...
            httpget.addRequestHeader("Host", "vimeo.com");
