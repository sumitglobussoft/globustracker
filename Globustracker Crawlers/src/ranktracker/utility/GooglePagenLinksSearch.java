...
//    String bestMatchLinkGoogle = "No Link Found";
...
//    }
    ...
    public boolean findRanks(Document doc, int page) throws MalformedURLException {
        Elements results = doc.select("div[id=ires] li[class=g]");
...
//        int tStop = 0;
//        //portno = fetchclientpage.generateRandomPortfrom100();
//        try {
...
//                responsebody = fetchclientpage.fetchPageSourcefromClientGoogle(newurl, mainpagename, portno, this.proxyList);
