...
<div id="datahide2" class="" style="display:none; margin-top:3%;">
    ...
    <div class="row">
        <div class="col-md-5 well" style="margin-left: 8%; min-height: 269px; max-height: 269px; overflow-y: scroll;">
            <div><div id="chart-container6"></div></div>
        </div>
        <div class="col-md-5 well" style="margin-left: 15px; min-height: 269px; max-height: 269px; overflow-y: scroll;">
...
//                    pageSize: '6'
        ...
        viewSelector.on('change', function (ids) {
            ...
            setTimeout(function () {
                changelogdatachart6();
                var totalpercentnewsession = dataChart6['Na']['totalsForAllResults']['ga:percentNewSessions'];
                var PercentNewSession = parseFloat(totalpercentnewsession).toFixed(2);
                $("#percentnewsession").text(PercentNewSession + " %");
            }, 8000);

            function changelogdatachart6() {
...
//                    pageSize: '6'
        ...
        viewSelector.on('change', function (ids) {
            ...
            setTimeout(function () {
                changelogdatachart7();
                var totalpageuserSession = dataChart7['Na']['totalsForAllResults']['ga:users'];
                $("#pageuserSession").text(totalpageuserSession);
            }, 8000);

            function changelogdatachart7() {
                $(document.body).find('.google-visualization-table-table >tbody>tr').each(function () {
                    var row = $(this);//.html();
                    row.find('td').each(function () {
                        var td = $(this).html();
        ...
        viewSelector.on('change', function (ids) {
            ...
            setTimeout(function () {
                var totalAvgSessionDuration = dataChart8['Na']['totalsForAllResults']['ga:avgSessionDuration'];
        ...
        viewSelector.on('change', function (ids) {
            ...
            setTimeout(function () {
                var totalpageviews = dataChart['Na']['totalsForAllResults']['ga:pageviews'];
