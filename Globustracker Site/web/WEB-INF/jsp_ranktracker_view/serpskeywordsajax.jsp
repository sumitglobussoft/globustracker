...
<div id="fade_away1">              
    <div class="common_text" id="msg" style="color: red; margin: 0px 0px 20px 10px"></div>           
</div>
<!-- widget grid -->
...
<script type="text/javascript">
                            ...
                            function refreshGoogleKeyword(keyworId, keywordName) {
                                ...
                                $.ajax({
                                    type: "Get",
                                    url: "refreshSerpsGoogleKeyword.htm",
                                    data: {
                                        jString: jString
                                    },
                            ...
                            function refreshYahooKeyword(keyworId, keywordName) {
                                ...
                                $.ajax({
                                    type: "Get",
                                    url: "refreshSerpsYahooKeyword.htm",
                                    data: {
                                        jString: jString
                                    },
                                    success: function (response) {
                            ...
                            function refreshBingKeyword(keyworId, keywordName) {
                                ...
                                $.ajax({
                                    type: "Get",
                                    url: "refreshSerpsBingKeyword.htm",
                                    data: {
                                        jString: jString
                                    },
                                    success: function (response) {
