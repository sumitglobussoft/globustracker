    ...
    <body id="signup" style="margin-bottom: 90px;">
        ...
        <div class="container">
            <div class="row header">
                <div class="col-md-12">
                    <h3 class="logo">
                        <a href="home.action"><img class="img-responsive img_mid" src="https://s3.amazonaws.com/images-globustracker/Globustracker-logo-present.png" alt="GlobusTracker"></a>
                    </h3>
